...
ct_4 <- readRDS(paste0("../data/",cell_type,"/",cell_type,sample_id[4],"/",cell_type,sample_id[4],"_preQC.rds"))
...
rownames_list[[4]] <- rownames(ct_4_qc)
...
colnames_list[[4]] <- colnames(ct_4_qc)
...
obj3_tomerge <- RenameCells(obj3_tomerge, add.cell.id = 5)
